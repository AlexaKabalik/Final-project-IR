...
class MultiFileReader:
    ...
    def read(self, locs, n_bytes, posting_list_path):
        b = []
        for f_name, offset in locs:
            if f_name not in self._open_files:
                self._open_files[f_name] = open(posting_list_path+'/'+f_name, 'rb')
...
class InvertedIndex:  
    ...
    def read_index(base_dir, name):
        path_to_drive = '/content/drive/MyDrive/final_project/title_postings'
        with open(Path(path_to_drive) / f'{name}.pkl', 'rb') as f:
    ...
    def write_a_posting_list(b_w_pl, bucket_name):
        ...
        with closing(MultiFileWriter('./title_postings',bucket_id, bucket_name)) as writer:
